            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center space-y-6 md:space-y-0 gap-5">
              ...
              <div className="text-center md:text-left">
                ...
                <p className=" text-center">
                  Your ultimate quiz platform to test, improve, and track your
              ...
              <div className=" text-center flex flex-col">
                ...
                <ul>
                  ...
                  <li>
                    <a href="/about" className=" hover:text-[#5C0096]">
                      About
                    </a>
                  </li>
                  <li>
                    <a href="/quizes" className=" hover:text-[#5C0096]">
                      All Quizes
                    </a>
                  </li>
                  <li>
                    <a href="/contact" className=" hover:text-[#5C0096]">
                      Contact
                    </a>
                  </li>
                </ul>
