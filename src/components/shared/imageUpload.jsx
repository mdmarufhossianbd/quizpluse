...
const ImageUpload = ({ setFormData, boxHeight }) => {
            ...
            {loading ? <div className='h-[150px] w-full rounded flex justify-center items-center'><Image src={uploading} width={100} height={100} alt='uploading' /></div> :
                imageUrl ?
                    <div className='relative'>
                        <Image className={`h-[${boxHeight}] w-full rounded border border-gray-400 object-cover`} src={imageUrl} height={250} width={250} alt='imageUrl' />
