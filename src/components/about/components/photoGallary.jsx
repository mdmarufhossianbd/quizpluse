  ...
  const photos = [
    {
      title: "Image1",
      Image_URL:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5gpDGkul4kz7YIZ1KQgxQGDjt-bnrYJ1xXg&s",
    },
    {
      title: "Image2",
      Image_URL:
    ...
    },
    {
      title: "Image3",
      Image_URL:
        "https://www.wikihow.com/images/f/ff/General_knowledge_quiz.png",
    },
    {
      title: "Image4",
      Image_URL:
    ...
    },
    {
      title: "Image5",
      Image_URL:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtReU98b-aS4kOvEeEG6Hi48wybHwhXgWNMw&s",
    },
    {
      title: "Image6",
      Image_URL:
        "https://europedirect.nicecotedazur.org/wp-content/uploads/2022/01/llustration-jeux-ced-1024x477.png",
    },
  ];
      ...
      <LightGallery onInit={onInit} speed={500} plugins={[lgThumbnail, lgZoom]}>
        ...
        <div className="grid grid-cols-3 gap-4 m-4">
          ...
          {photos.map((item, index) => {
            ...
            const positionClass =
              index === 2 || index === 0 ? "relative top-32 left-0" : "";
