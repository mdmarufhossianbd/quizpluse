...
const Register = () => {
    return (
        <div className="my-10 md:my-14 lg:my-16 xl:my-20 px-5">
            <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row gap-10 items-center bg-[#f5f5f5] rounded-md ">
                ...
                <div className="md:w-1/2 w-full">
                    <Image className="w-full h-[800px] md:rounded-r-md rounded-t-md" src={loginImage} width={500} height={800} alt="login" unoptimized priority />
                </div>
            </div>
        </div>
    );
